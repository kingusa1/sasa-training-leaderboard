    ...
    <div className="min-h-screen lux-bg relative flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md py-8">
        ...
        <div className="text-center mb-8 lux-card" style={{ animationDelay: '0.1s' }}>
          ...
          <p className="text-white/40 mt-2 text-sm">Create Your Agent Account</p>
        </div>

        {/* Form Card */}
        <div className="lux-glass-white rounded-2xl p-6 sm:p-8 shadow-2xl shadow-black/20 lux-card" style={{ animationDelay: '0.2s' }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-[#002E59] text-xs font-semibold mb-2 uppercase tracking-wider">Full Name</label>
            ...
            <div>
              <label className="block text-[#002E59] text-xs font-semibold mb-2 uppercase tracking-wider">Confirm Password</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full relative overflow-hidden bg-gradient-to-r from-[#002E59] via-[#004686] to-[#002E59] bg-[length:200%_100%] py-3.5 rounded-xl font-bold text-white hover:shadow-xl hover:shadow-[#004686]/20 transition-all duration-500 disabled:opacity-50 active:scale-[0.99] mt-2"
          ...
          <p className="text-center text-gray-400 mt-6 text-sm">
            ...
            <Link href="/login" className="text-[#004686] hover:text-[#002E59] font-semibold transition-colors">
              Sign In
            </Link>
          </p>
        </div>
